...
<<<<<<< HEAD
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.12.1/apps/app2/cc3220/build_contexts/build_ctx_965279510/build/gen/ /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/cc3220/src/cc3220_sys_config.yaml /data/fwbuild-volumes/2.12.1/apps/app2/cc3220/build_contexts/build_ctx_965279510/build/gen/mos_conf_schema.yml
=======
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.12.1/apps/app3/cc3220/build_contexts/build_ctx_874193766/build/gen/ /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/cc3220/src/cc3220_sys_config.yaml /data/fwbuild-volumes/2.12.1/apps/app3/cc3220/build_contexts/build_ctx_874193766/build/gen/mos_conf_schema.yml
...
struct mgos_config_wifi_sta {
  ...
  char *dhcp_hostname;
  char *eap_method;
  int eap_cert_validation_disable;
};
...
#define MGOS_CONFIG_HAVE_I2C_SDA_PIN
int         mgos_config_get_i2c_sda_pin(struct mgos_config *cfg);
#define MGOS_CONFIG_HAVE_I2C_SCL_PIN
int         mgos_config_get_i2c_scl_pin(struct mgos_config *cfg);
...
#define MGOS_CONFIG_HAVE_WIFI_STA_EAP_METHOD
const char *mgos_config_get_wifi_sta_eap_method(struct mgos_config *cfg);
#define MGOS_CONFIG_HAVE_WIFI_STA_EAP_CERT_VALIDATION_DISABLE
int         mgos_config_get_wifi_sta_eap_cert_validation_disable(struct mgos_config *cfg);
...
#define MGOS_CONFIG_HAVE_WIFI_STA1_EAP_METHOD
const char *mgos_config_get_wifi_sta1_eap_method(struct mgos_config *cfg);
#define MGOS_CONFIG_HAVE_WIFI_STA1_EAP_CERT_VALIDATION_DISABLE
int         mgos_config_get_wifi_sta1_eap_cert_validation_disable(struct mgos_config *cfg);
...
#define MGOS_CONFIG_HAVE_WIFI_STA2_EAP_METHOD
const char *mgos_config_get_wifi_sta2_eap_method(struct mgos_config *cfg);
#define MGOS_CONFIG_HAVE_WIFI_STA2_EAP_CERT_VALIDATION_DISABLE
int         mgos_config_get_wifi_sta2_eap_cert_validation_disable(struct mgos_config *cfg);
...
void mgos_config_set_i2c_sda_pin(struct mgos_config *cfg, int         val);
void mgos_config_set_i2c_scl_pin(struct mgos_config *cfg, int         val);
...
void mgos_config_set_wifi_sta_eap_method(struct mgos_config *cfg, const char *val);
void mgos_config_set_wifi_sta_eap_cert_validation_disable(struct mgos_config *cfg, int         val);
...
void mgos_config_set_wifi_sta1_eap_method(struct mgos_config *cfg, const char *val);
void mgos_config_set_wifi_sta1_eap_cert_validation_disable(struct mgos_config *cfg, int         val);
...
void mgos_config_set_wifi_sta2_eap_method(struct mgos_config *cfg, const char *val);
void mgos_config_set_wifi_sta2_eap_cert_validation_disable(struct mgos_config *cfg, int         val);
...
#define MGOS_SYS_CONFIG_HAVE_I2C_SDA_PIN
static inline int         mgos_sys_config_get_i2c_sda_pin(void) { return mgos_config_get_i2c_sda_pin(&mgos_sys_config); }
#define MGOS_SYS_CONFIG_HAVE_I2C_SCL_PIN
static inline int         mgos_sys_config_get_i2c_scl_pin(void) { return mgos_config_get_i2c_scl_pin(&mgos_sys_config); }
...
#define MGOS_SYS_CONFIG_HAVE_WIFI_STA_EAP_METHOD
static inline const char *mgos_sys_config_get_wifi_sta_eap_method(void) { return mgos_config_get_wifi_sta_eap_method(&mgos_sys_config); }
#define MGOS_SYS_CONFIG_HAVE_WIFI_STA_EAP_CERT_VALIDATION_DISABLE
static inline int         mgos_sys_config_get_wifi_sta_eap_cert_validation_disable(void) { return mgos_config_get_wifi_sta_eap_cert_validation_disable(&mgos_sys_config); }
...
#define MGOS_SYS_CONFIG_HAVE_WIFI_STA1_EAP_METHOD
static inline const char *mgos_sys_config_get_wifi_sta1_eap_method(void) { return mgos_config_get_wifi_sta1_eap_method(&mgos_sys_config); }
#define MGOS_SYS_CONFIG_HAVE_WIFI_STA1_EAP_CERT_VALIDATION_DISABLE
static inline int         mgos_sys_config_get_wifi_sta1_eap_cert_validation_disable(void) { return mgos_config_get_wifi_sta1_eap_cert_validation_disable(&mgos_sys_config); }
...
#define MGOS_SYS_CONFIG_HAVE_WIFI_STA2_EAP_METHOD
static inline const char *mgos_sys_config_get_wifi_sta2_eap_method(void) { return mgos_config_get_wifi_sta2_eap_method(&mgos_sys_config); }
#define MGOS_SYS_CONFIG_HAVE_WIFI_STA2_EAP_CERT_VALIDATION_DISABLE
static inline int         mgos_sys_config_get_wifi_sta2_eap_cert_validation_disable(void) { return mgos_config_get_wifi_sta2_eap_cert_validation_disable(&mgos_sys_config); }
...
static inline void mgos_sys_config_set_i2c_sda_pin(int         val) { mgos_config_set_i2c_sda_pin(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_i2c_scl_pin(int         val) { mgos_config_set_i2c_scl_pin(&mgos_sys_config, val); }
...
static inline void mgos_sys_config_set_wifi_sta_eap_method(const char *val) { mgos_config_set_wifi_sta_eap_method(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_wifi_sta_eap_cert_validation_disable(int         val) { mgos_config_set_wifi_sta_eap_cert_validation_disable(&mgos_sys_config, val); }
...
static inline void mgos_sys_config_set_wifi_sta1_eap_method(const char *val) { mgos_config_set_wifi_sta1_eap_method(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_wifi_sta1_eap_cert_validation_disable(int         val) { mgos_config_set_wifi_sta1_eap_cert_validation_disable(&mgos_sys_config, val); }
...
static inline void mgos_sys_config_set_wifi_sta2_eap_method(const char *val) { mgos_config_set_wifi_sta2_eap_method(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_wifi_sta2_eap_cert_validation_disable(int         val) { mgos_config_set_wifi_sta2_eap_cert_validation_disable(&mgos_sys_config, val); }
