...
const struct mgos_conf_entry mgos_config_schema_[132] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 131},
  ...
  {.type = CONF_TYPE_INT, .key = "sda_pin", .offset = offsetof(struct mgos_config, i2c.sda_pin)},
  {.type = CONF_TYPE_INT, .key = "scl_pin", .offset = offsetof(struct mgos_config, i2c.scl_pin)},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "wifi", .offset = offsetof(struct mgos_config, wifi), .num_desc = 65},
  ...
  {.type = CONF_TYPE_STRING, .key = "eap_method", .offset = offsetof(struct mgos_config, wifi.sta.eap_method)},
  {.type = CONF_TYPE_BOOL, .key = "eap_cert_validation_disable", .offset = offsetof(struct mgos_config, wifi.sta.eap_cert_validation_disable)},
  ...
  {.type = CONF_TYPE_STRING, .key = "eap_method", .offset = offsetof(struct mgos_config, wifi.sta1.eap_method)},
  {.type = CONF_TYPE_BOOL, .key = "eap_cert_validation_disable", .offset = offsetof(struct mgos_config, wifi.sta1.eap_cert_validation_disable)},
  ...
  {.type = CONF_TYPE_STRING, .key = "eap_method", .offset = offsetof(struct mgos_config, wifi.sta2.eap_method)},
  {.type = CONF_TYPE_BOOL, .key = "eap_cert_validation_disable", .offset = offsetof(struct mgos_config, wifi.sta2.eap_cert_validation_disable)},
...
void mgos_config_set_wifi_sta_eap_method(struct mgos_config *cfg, const char *val) {
  mgos_conf_set_str(&cfg->wifi.sta.eap_method, val);
}
void mgos_config_set_wifi_sta_eap_cert_validation_disable(struct mgos_config *cfg, int         val) {
  cfg->wifi.sta.eap_cert_validation_disable = val;
}
...
void mgos_config_set_wifi_sta1_eap_method(struct mgos_config *cfg, const char *val) {
  mgos_conf_set_str(&cfg->wifi.sta1.eap_method, val);
}
void mgos_config_set_wifi_sta1_eap_cert_validation_disable(struct mgos_config *cfg, int         val) {
  cfg->wifi.sta1.eap_cert_validation_disable = val;
}
...
void mgos_config_set_wifi_sta2_eap_method(struct mgos_config *cfg, const char *val) {
  mgos_conf_set_str(&cfg->wifi.sta2.eap_method, val);
}
void mgos_config_set_wifi_sta2_eap_cert_validation_disable(struct mgos_config *cfg, int         val) {
  cfg->wifi.sta2.eap_cert_validation_disable = val;
}
